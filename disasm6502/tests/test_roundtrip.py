...
def test_smoke_roundtrip():
    ...
    src = REPO_ROOT / "tools" / "smoke_6502.bin"
    if not src.exists():
        pytest.skip("tools/smoke_6502.bin missing")
...
def test_loader_223_roundtrip():
    ...
    """
    src = REPO_ROOT / "cpm-investigation" / "loader_223.bin"
    if not src.exists():
        pytest.skip("cpm-investigation/loader_223.bin missing")
