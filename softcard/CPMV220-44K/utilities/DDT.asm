...
; their real cells: $005B = REC_BUF_POS (record-buffer index), $005D = TFCB+FCB.DIRECTORY_ENTRY.FN,
; $0065 = TFCB+FCB.DIRECTORY_ENTRY.FT, $007C = TFCB+FCB.CR.
...
STARTUP:
        ...
        INC HL                           ; $06F4  23
        LD (HL),D                        ; $06F5  72
        LD A,(TFCB+FCB.DIRECTORY_ENTRY.FN)              ; $06F6  3A 5D 00
        CP $20                           ; $06F9  FE 20
...
CMD_I_INPUT:
        ...
        LD C,$09                         ; $093D  0E 09
        LD HL,TFCB+FCB.DIRECTORY_ENTRY.FN               ; $093F  21 5D 00
CMD_I_NAME_LOOP:
        LD (HL),A                        ; $0942  77
        INC HL                           ; $0943  23
        DEC C                            ; $0944  0D
...
CMD_I_EXT:
        ...
        LD HL,TFCB+FCB.DIRECTORY_ENTRY.FT              ; $0966  21 65 00
CMD_I_EXT_LOOP:
...
IS_HEX_REQ:
        LD HL,TFCB+FCB.DIRECTORY_ENTRY.FT              ; $099E  21 65 00
        LD A,(HL)                        ; $09A1  7E
        AND $7F                          ; $09A2  E6 7F
        CP $48                           ; $09A4  FE 48
        RET NZ                           ; $09A6  C0
