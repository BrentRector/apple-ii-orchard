...
L_0200:
        ...
        DEFW    $0000                    ; $0202
        DEFW    SUB_52F8                 ; $0204
        DEFW    SUB_52F8_1+1             ; $0206
        DEFW    SUB_52F8_2+1             ; $0208
        DEFW    $0000                    ; $020A
        DEFW    SUB_56C8                 ; $020C
...
ERRMSG_TBL_UNDEF_FN_3:
        ...
        LD C,H                           ; $06D6  4C
        LD B,L                           ; $06D7  45
        JR NZ,ERRMSG_TBL_UNDEF_FN_15     ; $06D8  20 77
        LD L,C                           ; $06DA  69
        LD (HL),H                        ; $06DB  74
        LD L,B                           ; $06DC  68
        LD L,A                           ; $06DD  6F
...
ERRMSG_TBL_UNDEF_FN_5:
        ...
        LD (HL),L                        ; $06F0  75
        LD (HL),H                        ; $06F1  74
        JR NZ,ERRMSG_TBL_UNDEF_FN_14     ; $06F2  20 57
        LD C,B                           ; $06F4  48
...
MSG_REDO_FROM_START_5:
        ...
        PUSH HL                          ; $190C  E5
        LD HL,FILE_FCB_SCRATCH_2         ; $190D  21 30 0A
...
STMT_READ_4:
        ...
        OR L                             ; $19FD  B5
        EX DE,HL                         ; $19FE  EB
        JP NZ,SUB_52F8_4                 ; $19FF  C2 15 53
...
GFX_SOFTSW_TXTCLR_4:
        LD BC,RESET_PRINT_STATE_2        ; $27FA  01 1E 44
GFX_SOFTSW_TXTCLR_5:
        LD BC,CLEAR_RESET_STORAGE_1+2    ; $27FD  01 1E 45
GFX_SOFTSW_TXTCLR_6:
        LD BC,ECHO_CTRL_CHAR_2+1         ; $2800  01 1E 46
...
SUB_2DC1_1:
        ...
        ADD HL,HL                        ; $2DD7  29
        EX DE,HL                         ; $2DD8  EB
        JR NC,SUB_2DC1_2                 ; $2DD9  30 04
        ADD HL,BC                        ; $2DDB  09
        JP C,IMULDIV_FINISH_2+1          ; $2DDC  DA F5 2D
SUB_2DC1_2:
        DEC A                            ; $2DDF  3D
        JR NZ,SUB_2DC1_1                 ; $2DE0  20 F1
        POP BC                           ; $2DE2  C1
        POP DE                           ; $2DE3  D1
...
PTRGET_9:
        ...
        LD A,(HL)                        ; $3C3C  7E
        SUB $28                          ; $3C3D  D6 28
        JP Z,PTRGET_SEARCH_FOUND_5       ; $3C3F  CA 35 3D
        SUB $33                          ; $3C42  D6 33
        JP Z,PTRGET_SEARCH_FOUND_5       ; $3C44  CA 35 3D
...
PTRGET_SEARCH_FOUND_3:
        ...
        JR NZ,PTRGET_SEARCH_FOUND_4      ; $3D2B  20 06
...
ARRAY_DIM_PUSH_LOOP:
        ...
        PUSH BC                          ; $3D51  C5
        DEC A                            ; $3D52  3D
        JR NZ,PTRGET_SEARCH_FOUND_7      ; $3D53  20 F8
        PUSH HL                          ; $3D55  E5
...
ARRAY_DIM_PUSH_LOOP_4:
        ...
        LD A,(HL)                        ; $3D8E  7E
        CP $2C                           ; $3D8F  FE 2C
        JP Z,PTRGET_SEARCH_FOUND_6       ; $3D91  CA 3B 3D
        CP $29                           ; $3D94  FE 29
...
EDIT_BUF_SHIFT_9:
        ...
        INC A                            ; $40C0  3C
EDIT_BUF_SHIFT_10:
        LD HL,FILE_FCB_SCRATCH_2         ; $40C1  21 30 0A
        RET Z                            ; $40C4  C8
        SCF                              ; $40C5  37
        PUSH AF                          ; $40C6  F5
        INC HL                           ; $40C7  23
...
PRINT_CRLF_IF_COL_1:
        LD (HL),$00                      ; $4401  36 00
        LD HL,FILE_FCB_SCRATCH_2         ; $4403  21 30 0A
...
INLIN_CR_FINISH:
        ...
        XOR A                            ; $4DA6  AF
        LD (HL),A                        ; $4DA7  77
        LD HL,FILE_FCB_SCRATCH_2         ; $4DA8  21 30 0A
        RET                              ; $4DAB  C9
...
SUB_52F8_2:
        LD BC,ERRMSG_TBL_UNDEF_FN_13     ; $52FD  01 3E 07
SUB_52F8_3:
        PUSH AF                          ; $5300  F5
...
SUB_52F8_4:
        ...
        JR NZ,SUB_52F8_6                 ; $531E  20 17
        LD E,D                           ; $5320  5A
        JR SUB_52F8_6                    ; $5321  18 14
SUB_52F8_5:
...
SUB_52F8_7:
        ...
        CP $20                           ; $5340  FE 20
        JR NZ,SUB_52F8_8                 ; $5342  20 04
        INC D                            ; $5344  14
        DEC D                            ; $5345  15
        JR NZ,SUB_52F8_7                 ; $5346  20 F2
SUB_52F8_8:
        CP $22                           ; $5348  FE 22
        JR NZ,SUB_52F8_9                 ; $534A  20 0E
        LD B,A                           ; $534C  47
        LD A,E                           ; $534D  7B
        CP $2C                           ; $534E  FE 2C
        LD A,B                           ; $5350  78
        JR NZ,SUB_52F8_9                 ; $5351  20 07
        LD D,B                           ; $5353  50
        LD E,B                           ; $5354  58
        CALL GETC_FILE_EOF               ; $5355  CD 89 58
        JR C,SUB_52F8_13                 ; $5358  38 43
SUB_52F8_9:
...
SUB_52F8_10:
        ...
        CP $22                           ; $5361  FE 22
        LD A,C                           ; $5363  79
        JR Z,SUB_52F8_11                 ; $5364  28 26
        CP $0D                           ; $5366  FE 0D
        PUSH HL                          ; $5368  E5
        JR Z,SUB_52F8_15                 ; $5369  28 4D
        POP HL                           ; $536B  E1
        CP $0A                           ; $536C  FE 0A
        JR NZ,SUB_52F8_11                ; $536E  20 1C
        LD C,A                           ; $5370  4F
        LD A,E                           ; $5371  7B
        CP $2C                           ; $5372  FE 2C
        LD A,C                           ; $5374  79
        ...
        JR C,SUB_52F8_13                 ; $537B  38 20
        CP $0D                           ; $537D  FE 0D
        JR NZ,SUB_52F8_11                ; $537F  20 0B
        LD A,E                           ; $5381  7B
        CP $20                           ; $5382  FE 20
        JR Z,SUB_52F8_12                 ; $5384  28 12
        CP $2C                           ; $5386  FE 2C
        LD A,$0D                         ; $5388  3E 0D
        JR Z,SUB_52F8_12                 ; $538A  28 0C
SUB_52F8_11:
        OR A                             ; $538C  B7
        JR Z,SUB_52F8_12                 ; $538D  28 09
        CP D                             ; $538F  BA
        JR Z,SUB_52F8_13                 ; $5390  28 0B
        CP E                             ; $5392  BB
        JR Z,SUB_52F8_13                 ; $5393  28 08
        CALL INPUT_BUF_STORE             ; $5395  CD EE 53
SUB_52F8_12:
        CALL GETC_FILE_EOF               ; $5398  CD 89 58
        JR NC,SUB_52F8_10                ; $539B  30 C2
SUB_52F8_13:
        PUSH HL                          ; $539D  E5
        CP $22                           ; $539E  FE 22
        JR Z,SUB_52F8_14                 ; $53A0  28 04
        CP $20                           ; $53A2  FE 20
        JR NZ,SUB_52F8_17                ; $53A4  20 23
SUB_52F8_14:
        CALL GETC_FILE_EOF               ; $53A6  CD 89 58
        JR C,SUB_52F8_17                 ; $53A9  38 1E
        CP $20                           ; $53AB  FE 20
        JR Z,SUB_52F8_14                 ; $53AD  28 F7
        CP $2C                           ; $53AF  FE 2C
        JP Z,SUB_52F8_17                 ; $53B1  CA C9 53
        CP $0D                           ; $53B4  FE 0D
        JR NZ,SUB_52F8_16                ; $53B6  20 09
SUB_52F8_15:
        CALL GETC_FILE_EOF               ; $53B8  CD 89 58
        JR C,SUB_52F8_17                 ; $53BB  38 0C
        CP $0A                           ; $53BD  FE 0A
        JR Z,SUB_52F8_17                 ; $53BF  28 08
SUB_52F8_16:
...
SUB_52F8_18:
        LD (HL),$00                      ; $53CA  36 00
        LD HL,FILE_FCB_SCRATCH_2         ; $53CC  21 30 0A
        LD A,E                           ; $53CF  7B
        SUB $20                          ; $53D0  D6 20
        JR Z,SUB_52F8_19                 ; $53D2  28 08
        LD B,D                           ; $53D4  42
        LD D,$00                         ; $53D5  16 00
...
SUB_56C8:
        ...
        JP Z,ERR_CODED_ENTRY_4+1         ; $56CB  CA 70 0D
        CP $02                           ; $56CE  FE 02
        JP Z,ERR_CODED_ENTRY_2+1         ; $56D0  CA 6A 0D
SUB_56C8_1:
        LD HL,$0027                      ; $56D3  21 27 00
        ADD HL,BC                        ; $56D6  09
        LD A,(HL)                        ; $56D7  7E
        OR A                             ; $56D8  B7
        JR Z,SUB_56C8_3                  ; $56D9  28 1E
        LD A,(BC)                        ; $56DB  0A
        CP $03                           ; $56DC  FE 03
        JR Z,SUB_56C8_3                  ; $56DE  28 19
        INC HL                           ; $56E0  23
        LD A,(HL)                        ; $56E1  7E
        OR A                             ; $56E2  B7
        JR NZ,SUB_56C8_2                 ; $56E3  20 09
        PUSH BC                          ; $56E5  C5
        LD H,B                           ; $56E6  60
        LD L,C                           ; $56E7  69
        CALL FILE_READ_RECORD_FCB        ; $56E8  CD 42 58
        POP BC                           ; $56EB  C1
        JR SUB_56C8_1                    ; $56EC  18 E5
SUB_56C8_2:
        LD A,$80                         ; $56EE  3E 80
        SUB (HL)                         ; $56F0  96
        LD C,A                           ; $56F1  4F
...
STMT_OPEN_ZERO_FCB:
        ...
        LD A,(HL)                        ; $5A44  7E
        CP $03                           ; $5A45  FE 03
        JP Z,STMT_OPEN_ZERO_FCB_1        ; $5A47  CA 56 5A
        CP $01                           ; $5A4A  FE 01
...
STMT_OPEN_ZERO_FCB_2:
        ...
        INC HL                           ; $5A5D  23
        DEC C                            ; $5A5E  0D
        JR NZ,STMT_OPEN_ZERO_FCB_2       ; $5A5F  20 FB
...
COLD_SIGNON:
        ...
        LD H,L                           ; $607B  65
        LD H,H                           ; $607C  64
        JR NZ,SIGNON_TEXT_4              ; $607D  20 62
        LD A,C                           ; $607F  79
        JR NZ,SIGNON_TEXT_1              ; $6080  20 4D
        LD L,C                           ; $6082  69
        LD H,E                           ; $6083  63
        LD (HL),D                        ; $6084  72
        LD L,A                           ; $6085  6F
...
MSG_BYTES_FREE:
        ...
        LD H,L                           ; $6091  65
        LD (HL),E                        ; $6092  73
        JR NZ,SIGNON_TEXT_6              ; $6093  20 66
        LD (HL),D                        ; $6095  72
        LD H,L                           ; $6096  65
        LD H,L                           ; $6097  65
        DEC C                            ; $6098  0D
...
SIGNON_BANNER_HEADER:
        ...
        JR NZ,SIGNON_TEXT_7              ; $60A9  20 52
        LD H,L                           ; $60AB  65
        HALT                             ; $60AC  76
...
SIGNON_TEXT:
        ...
        LD L,H                           ; $60B8  6C
        LD H,L                           ; $60B9  65
        JR NZ,SIGNON_TEXT_8              ; $60BA  20 43
        LD D,B                           ; $60BC  50
        CPL                              ; $60BD  2F
        LD C,L                           ; $60BE  4D
...
SIGNON_TEXT_2:
        LD L,B                           ; $60D1  68
        LD (HL),H                        ; $60D2  74
        JR NZ,SIGNON_TEXT_7              ; $60D3  20 28
        LD B,E                           ; $60D5  43
        ADD HL,HL                        ; $60D6  29
