...
L_0603:
        ...
        LD H,L                           ; $0653  65
        LD H,H                           ; $0654  64
        JR NZ,SUB_064E_3                 ; $0655  20 75
        LD (HL),E                        ; $0657  73
        LD H,L                           ; $0658  65
        LD (HL),D                        ; $0659  72
        JR NZ,SUB_064E_2+1               ; $065A  20 66
        LD (HL),L                        ; $065C  75
        LD L,(HL)                        ; $065D  6E
        LD H,E                           ; $065E  63
        LD (HL),H                        ; $065F  74
        ...
        LD L,(HL)                        ; $06A7  6E
        LD H,L                           ; $06A8  65
        JR NZ,SUB_064E_8                 ; $06A9  20 62
        LD (HL),L                        ; $06AB  75
        LD H,(HL)                        ; $06AC  66
        LD H,(HL)                        ; $06AD  66
        LD H,L                           ; $06AE  65
        LD (HL),D                        ; $06AF  72
        JR NZ,SUB_064E_11                ; $06B0  20 6F
        HALT                             ; $06B2  76
        LD H,L                           ; $06B3  65
        LD (HL),D                        ; $06B4  72
        LD H,(HL)                        ; $06B5  66
...
DP_COPY_TEMP:
        ...
        LD BC,SUB_064E_7                 ; $30FA  01 00 07
DP_COPY_TEMP_1:
        LD A,(HL)                        ; $30FD  7E
        LD (DE),A                        ; $30FE  12
        LD (HL),C                        ; $30FF  71
