...
TPA_START_56:
        ...
        SBC A,A                          ; $045B  9F
        PUSH AF                          ; $045C  F5
        LD A,(TFCB+FCB.DIRECTORY_ENTRY.FN)                     ; $045D  3A 5D 00
        SUB $20                          ; $0460  D6 20
        SUB $01                          ; $0462  D6 01
        SBC A,A                          ; $0464  9F
        POP BC                           ; $0465  C1
...
FILE_STATUS_MAIN_2:
        LD A,(TFCB+FCB.DIRECTORY_ENTRY.FN)                     ; $0DE4  3A 5D 00
        CP $20                           ; $0DE7  FE 20
...
FILE_STATUS_MAIN_3:
        ...
        LD HL,TFCB+FCB.DIRECTORY_ENTRY.EX                     ; $0DFA  21 68 00
        LD (HL),$3F                      ; $0DFD  36 3F
        LD HL,TFCB+FCB.DIRECTORY_ENTRY.S2                     ; $0DFF  21 6A 00
        LD (HL),$3F                      ; $0E02  36 3F
