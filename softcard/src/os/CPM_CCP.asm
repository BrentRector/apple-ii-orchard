...
SUB_D3FC_1:
        ...
        OR (HL)                          ; $D406  B6
        LD (CDISK_ADDR),A                     ; $D407  32 04 00
        RET                              ; $D40A  C9
RESTORE_CDISK_DRIVE:
        LD A,(SUB_DB06_19)               ; $D40B  3A A8 DB
        LD (CDISK_ADDR),A                     ; $D40E  32 04 00
        RET                              ; $D411  C9
TO_UPPER:
        CP $61                           ; $D412  FE 61
        RET C                            ; $D414  D8
...
READ_COMMAND_LINE:
        ...
        LD HL,TBUFF                ; $D444  21 80 00
        LD BC,TBUFF                ; $D447  01 80 00
        LDIR                             ; $D44A  ED B0
...
SUB_D707_36:
        ...
        LD BC,IOBYTE_ADDR                     ; $D95D  01 03 00
        LDIR                             ; $D960  ED B0
SUB_D707_37:
