...
each needs its own source. All output round-trips byte-identical.
    ...
    python gen_bios.py                 # both 2.20 targets
    python gen_bios.py CPM220_BIOS_Disk
"""
...
# The 2.23 BIOS targets are retired -- the canonical 2.23 BIOS now lives in
# CPMV223-44K/os/CPM_BIOS.asm (regenerated by decompile_os, not this docs script).
TARGETS = {
