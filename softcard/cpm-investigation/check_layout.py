...
def main():
    ...
    with open('e:/Orchard/softcard/reference/softcard-cpm-archive/os/softcard-cpm2.20b-56k-system-disk1.po', 'rb') as f:
        raw = f.read()
    phys = reconstruct_physical('e:/Orchard/softcard/reference/softcard-cpm-archive/os/softcard-cpm2.20b-56k-system-disk1.po')
    ...
    with open('e:/Orchard/softcard/reference/softcard-cpm-archive/os/softcard-cpm2.23-44k-system.dsk', 'rb') as f:
        raw23 = f.read()
    phys23 = reconstruct_physical('e:/Orchard/softcard/reference/softcard-cpm-archive/os/softcard-cpm2.23-44k-system.dsk')
