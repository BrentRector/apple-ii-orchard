...
compare to the extracted region binary in softcard/cpm-investigation/. For each
...
HERE = Path(__file__).resolve().parent           # softcard/decompiled
...
INVEST = REPO / "softcard" / "cpm-investigation"
