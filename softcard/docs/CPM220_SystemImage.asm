...
; [AI] Entry point ($8000) of the CP/M 2.20 Console Command Processor, where the BIOS warm-boot
;       (WBOOT) hands control after loading the CCP+BDOS image; from here the CCP reads, parses, and
;       dispatches command lines (built-ins DIR/ERA/TYPE/SAVE/REN/USER, or external .COM programs).
CCP_ENTRY:
          RST $08                         ; $8000 CF
          RST $00                         ; $8001 C7
          INC DE                          ; $8002 13
