...
;   $DEAF -> BOOT_3+2             z80 skip idiom: enters the operand of $21 at $DEAD
...
L_DA00:
        JP BOOT                          ; $DA00  C3 A8 DE
L_DA03:
        JP WBOOT                         ; $DA03  C3 CC DA
L_DA06:
        JP CONST                         ; $DA06  C3 08 DB
L_DA09:
        JP CONIN                         ; $DA09  C3 12 DB
L_DA0C:
        JP CONOUT                        ; $DA0C  C3 43 DB
L_DA0F:
        JP LIST                          ; $DA0F  C3 66 DB
L_DA12:
        JP PUNCH                         ; $DA12  C3 75 DB
L_DA15:
        JP READER                        ; $DA15  C3 87 DB
L_DA18:
        JP HOME                          ; $DA18  C3 4B DD
L_DA1B:
        JP SELDSK                        ; $DA1B  C3 6D DD
L_DA1E:
        JP SETTRK                        ; $DA1E  C3 56 DD
L_DA21:
        JP SETSEC                        ; $DA21  C3 89 DD
L_DA24:
        JP SETDMA                        ; $DA24  C3 8E DD
L_DA27:
        JP READ                          ; $DA27  C3 93 DD
L_DA2A:
        JP WRITE                         ; $DA2A  C3 A3 DD
L_DA2D:
        XOR A                            ; $DA2D  AF
        RET                              ; $DA2E  C9
        DEFB    $00                                              ; $DA2F
...
DEVICE_INIT_ALL_1:
        ...
        LD A,(HL)                        ; $DAA9  7E
        SUB $03                          ; $DAAA  D6 03
        JR NZ,DEVICE_INIT_ALL_2          ; $DAAC  20 07
...
DEVICE_INIT_ALL_2:
        DEC A                            ; $DAB5  3D
        JR NZ,DEVICE_INIT_ALL_3          ; $DAB6  20 09
        CALL DEVICE_PARAM_LOOKUP         ; $DAB8  CD EE DC
...
DEVICE_INIT_ALL_3:
        DEC E                            ; $DAC1  1D
        JR NZ,DEVICE_INIT_ALL_1          ; $DAC2  20 E1
        RET                              ; $DAC4  C9
        DEFB    $21                                              ; $DAC5
...
WBOOT:
        ...
        CALL DEVICE_INIT_ALL             ; $DAD8  CD A2 DA
        XOR A                            ; $DADB  AF
        LD (BOOT_5),A                    ; $DADC  32 B4 DE
        LD (BOOT_3+2),A                  ; $DADF  32 AF DE
        LD A,$C3                         ; $DAE2  3E C3
        LD (WBOOT_VEC),A                 ; $DAE4  32 00 00
        LD HL,L_DA03                     ; $DAE7  21 03 DA
...
DEVICE_PARAM_LOOKUP:
        LD B,$B9                         ; $DCEE  06 B9
        JR NZ,DEVICE_PARAM_LOOKUP_1      ; $DCF0  20 03
        LD (HL),$80                      ; $DCF2  36 80
        RET                              ; $DCF4  C9
...
DEVICE_PARAM_LOOKUP_1:
        LD A,$1F                         ; $DCF5  3E 1F
        CP C                             ; $DCF7  B9
        JR C,DEVICE_PARAM_LOOKUP_2       ; $DCF8  38 33
...
WRITE_1:
        PUSH HL                          ; $DDFF  E5
        OR A                             ; $DE00  B7
        JR Z,WRITE_2                     ; $DE01  28 04
        XOR E                            ; $DE03  AB
        CP C                             ; $DE04  B9
        JR Z,WRITE_3                     ; $DE05  28 05
...
WRITE_2:
        DEC HL                           ; $DE07  2B
        DJNZ WRITE_1                     ; $DE08  10 F5
        JR WRITE_4                       ; $DE0A  18 21
...
WRITE_3:
        ...
        LD A,B                           ; $DE23  78
        CP $07                           ; $DE24  FE 07
        JR NZ,WRITE_4                    ; $DE26  20 05
        LD A,$02                         ; $DE28  3E 02
        LD (WRITE_5_2),A                 ; $DE2A  32 A3 DE
...
WRITE_4:
        XOR A                            ; $DE2D  AF
        LD (WRITE_5_3),A                 ; $DE2E  32 A4 DE
        LD A,(WRITE_5_1)                 ; $DE31  3A A2 DE
        OR A                             ; $DE34  B7
        LD HL,($F388)                    ; $DE35  2A 88 F3
        JR Z,WRITE_5                     ; $DE38  28 03
...
WRITE_5:
        ...
        DEFW    DEVICE_PARAM_LOOKUP_1_1  ; $DE8A
