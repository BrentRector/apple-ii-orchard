...
Canonical address → name mappings consumed by the disassemblers (`shared/disasm6502/`, `shared/disasm_z80/`) and used directly as labels in hand-annotated `.asm` source.
