...
class Z80CPU:
    """Minimal Z-80 emulator. Opcodes implemented on demand."""
    ...
    def __init__(self):
        ...
        # memory read/write. Each hook receives (addr, value_for_writes_or_None)
        # and returns the actual byte value (read_hook) or None.
        self.read_hook = None
