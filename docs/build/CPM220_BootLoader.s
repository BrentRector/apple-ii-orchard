...
BOOT_STUB:
            ...
            CPY #$0B                        ; $081E C0 0B
            BNE $0825                       ; $0820 D0 03
            JMP $1000                       ; $0822 4C 00 10
            LDA $082D,Y                     ; $0825 B9 2D 08
            STA $3D                         ; $0828 85 3D
            JMP ($003E)                     ; $082A 6C 3E 00
            BRK                             ; $082D 00
            KIL                             ; $082E 02
            NOP $06                         ; $082F 04 06
            PHP                             ; $0831 08
            ASL                             ; $0832 0A
            NOP $010E                       ; $0833 0C 0E 01
            SLO ($05,X)                     ; $0836 03 05
            SLO $09                         ; $0838 07 09
            ANC #$0D                        ; $083A 0B 0D
            SLO $C3A0                       ; $083C 0F A0 C3
            DCP $D9D0                       ; $083F CF D0 D9
...
STAGE2_ENTRY:
            ...
            JSR $FE93  ; OUTPORT            ; $1018 20 93 FE
            JSR $FE89  ; INPORT             ; $101B 20 89 FE
            PLA                             ; $101E 68
            LDX #$FF                        ; $101F A2 FF
            TXS                             ; $1021 9A
            CMP #$06                        ; $1022 C9 06
            ...
            BEQ $1033                       ; $102B F0 06
            JSR $FDED  ; COUT (print character); $102D 20 ED FD
            INY                             ; $1030 C8
            BNE $1028                       ; $1031 D0 F5
            ...
            BEQ $10E4                       ; $10DC F0 06
            JSR $FDED  ; COUT (print character); $10DE 20 ED FD
            INY                             ; $10E1 C8
            BNE $10D9                       ; $10E2 D0 F5
