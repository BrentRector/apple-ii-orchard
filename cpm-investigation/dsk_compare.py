...
def main():
    images = {
        '223':    load_physical('e:/Orchard/CPMV233.DSK'),
        '220-d1': load_physical('e:/Orchard/CPM220Disk1.po'),
    }
    diff_summary(images, max_track=3)

    # Also: confirm 220 d1 vs d2 are identical for system area
    d1 = load_physical('e:/Orchard/CPM220Disk1.po')
    d2 = load_physical('e:/Orchard/CPM220Disk2.po')
