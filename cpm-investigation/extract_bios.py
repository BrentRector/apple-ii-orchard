...
def main():
    cases = [
        ('2.23', 'e:/Orchard/CPMV233.DSK',    0x02400),  # physical-order offset
        ('2.20', 'e:/Orchard/CPM220Disk1.po', 0x02200),
    ]
    ...
    for label, path, offset in cases:
        ...
        out_path = f'e:/Orchard/cpm-investigation/bios_{label.replace(".","")}.bin'
