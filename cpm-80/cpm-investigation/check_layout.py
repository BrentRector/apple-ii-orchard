...
def main():
    ...
    with open('e:/Orchard/cpm-80/disks/CPM220Disk1.po', 'rb') as f:
        raw = f.read()
    phys = reconstruct_physical('e:/Orchard/cpm-80/disks/CPM220Disk1.po')
    ...
    with open('e:/Orchard/cpm-80/disks/CPMV233.DSK', 'rb') as f:
        raw23 = f.read()
    phys23 = reconstruct_physical('e:/Orchard/cpm-80/disks/CPMV233.DSK')
