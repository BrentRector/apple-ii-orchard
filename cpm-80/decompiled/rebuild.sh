...
#
#     bash cpm-80/decompiled/rebuild.sh CPMV233     # 2.23 -> CPMV233.DSK
#     bash cpm-80/decompiled/rebuild.sh CPM220      # 2.20 -> CPM220Disk1.po
#
...
DISTRO="${1:-}"
case "$DISTRO" in
  CPMV233) VARIANT=223; DISK="$ROOT/cpm-80/disks/CPMV233.DSK" ;;
  CPM220)  VARIANT=220; DISK="$ROOT/cpm-80/disks/CPM220Disk1.po" ;;
