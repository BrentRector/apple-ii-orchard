...
;   $DEAF -> COLD_BOOT_IMPL_2+2   z80 skip idiom: enters the operand of $21 at $DEAD
...
LISTST:
        ...
        RET                              ; $DA2E  C9
        DEFB    $00                                              ; $DA2F
; [AI] Sector-translate BIOS entry (slot 16); here a null translation that simply returns the
;       logical sector in HL unchanged (no skew table applied).
SECTRAN:
        LD H,B                           ; $DA30  60
        LD L,C                           ; $DA31  69
        RET                              ; $DA32  C9
...
WBOOT_IMPL:
        ...
        XOR A                            ; $DADB  AF
        LD (COLD_BOOT_IMPL_3),A          ; $DADC  32 B4 DE
        LD (COLD_BOOT_IMPL_2+2),A        ; $DADF  32 AF DE
        LD A,$C3                         ; $DAE2  3E C3
...
COLD_BOOT_IMPL_3:
    ...
    SAVEBIN "build/CPM220_BIOS_Disk.bin", $DA00, $0500
