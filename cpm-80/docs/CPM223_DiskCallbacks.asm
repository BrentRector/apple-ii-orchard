...
;
; VERIFIED PROVENANCE (emulator byte search, 2026-06-11): these
...
; [AI] Entry of the BDOS-support thunk block (runtime Z-80 $A900): a table of small parameter-
;       setup-then-jump stubs that CCP and other BDOS callers index into to invoke specific BDOS
;       routines.
CALLBACKS_START:
          XOR C                           ; $1A00 A9
