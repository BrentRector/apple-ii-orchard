...
python -m cpm_pipeline decompile-os   cpm-80/disks/CPMV233.DSK out/os --ai --ai-backend cli

# 3. Decompile every program in the CP/M filesystem (emulation-assisted) to source.
python -m cpm_pipeline decompile-disk cpm-80/disks/CPMV233.DSK out --select <each .COM> --ai --ai-backend cli

# 4. Reassemble EVERYTHING and rebuild the whole disk from source; verify byte-identical.
python -m cpm_pipeline.reconstruct cpm-80/disks/CPMV233.DSK build/cpm223_fromsource.dsk
