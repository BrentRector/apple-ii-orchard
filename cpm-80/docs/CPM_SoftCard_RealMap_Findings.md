...
Empirical confirmation: `cpm-80/cpm-investigation/emu_softcard_v2.py`
...
- `cpm-80/cpm-investigation/emu_softcard_realmap.py` — one-shot probe: 6502
  ...
  reaching BDOS.
- `cpm-80/cpm-investigation/emu_softcard_v2.py` — THE bidirectional emulator:
...
hook). Contract captured from cpm-80/docs/CPM223_RWTS.asm:
...
- `cpm-80/cpm-investigation/videx_rom24.s` — disasm6502 output of Videx ROM
