...
; [AI] Entry point of the 6502 RWTS block at Apple $0A00: pre-nibblizes the 256-byte sector at
;       $0C00 into the $0900/$0D00 6-and-2 GCR buffers in preparation for writing it to the current
;       track/sector. This is the head of the whole disk engine the boot stub loads into $0A00-$0FFF
;       and that the SoftCard BIOS calls to move CP/M sectors to and from Apple memory.
WRITE_SECTOR:
          LDX #$55                        ; $0A00 A2 55
          LDA #$00                        ; $0A02 A9 00
