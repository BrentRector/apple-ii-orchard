...
- New module `cpm-80/cpm_pipeline/disk_writer.py` (or similar). Inverse of
  the format-reading code in nibbler.
- CLI tool: `python -m cpm_pipeline build-dsk <chunk-list> <output.dsk>`.
- Update `cpm-80/cpm-investigation/build_dsk.py` to use the new module
...
- New `cpm-80/cpm_pipeline/disk_format.py` that produces a structured
...
- New module `cpm-80/cpm_pipeline/loader_trace.py`.
...
- New module `cpm-80/cpm_pipeline/z80_trace.py`.
...
- New module `cpm-80/cpm_pipeline/handoff.py`.
...
- New module `cpm-80/cpm_pipeline/version_delta.py`.
...
- New module `cpm-80/cpm_pipeline/generate.py`.
