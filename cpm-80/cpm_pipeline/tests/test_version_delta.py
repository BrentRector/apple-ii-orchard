...
@pytest.mark.skipif(not (_has("disks/CPMV233.DSK") and _has("disks/CPM220Disk1.po")),
...
def test_diff_2_20_vs_2_23_surfaces_videx_fix():
    ...
    """
    delta = compare_disks(
        REPO_ROOT / "disks" / "CPM220Disk1.po",
        REPO_ROOT / "disks" / "CPMV233.DSK",
    )
    # Variant
...
@pytest.mark.skipif(not (_has("disks/CPM220Disk1.po") and _has("disks/CPMV233.DSK")),
                    reason="both disks needed")
