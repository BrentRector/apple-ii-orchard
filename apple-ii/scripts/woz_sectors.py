...
Usage:
    ...
    Default paths (override by editing APPLE_PANIC / OUTPUT_DIR):
        woz_path - apple-ii/apple-panic/Apple Panic - Disk 1, Side A.woz
        out_path - apple-ii/apple-panic/output/ApplePanic_original_ordered.bin
        Also reads apple-ii/apple-panic/ApplePanic_runtime.bin for pattern comparison
