...
Usage:
    ...
    Default paths (override by editing APPLE_PANIC / OUTPUT_DIR):
        apple-ii/apple-panic/ApplePanic_runtime.bin       - cracked runtime image (from build_runtime.py)
        apple-ii/apple-panic/output/ApplePanic_original_raw.bin - raw WOZ sector dump (from woz_decode.py)
