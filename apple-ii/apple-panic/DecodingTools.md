...
The [`nibbler`](../../shared/nibbler/) package is the reusable successor to the investigation scripts. It works on any WOZ2 disk image, not just Apple Panic.
...
See [`nibbler/USAGE.md`](../../shared/nibbler/USAGE.md) for full documentation.
...
**Invocation**: `python apple-ii/scripts/disasm_rwts.py [--woz PATH]`
...
**Invocation**: `python apple-ii/scripts/disasm_stage2.py [--woz PATH]`
...
**Invocation**: `python apple-ii/scripts/decode_track0.py [--woz PATH] [--output-dir DIR]`
**Output**:
...
**Invocation**: `python apple-ii/scripts/boot_emulate.py [--woz PATH] [--output-dir DIR]`
**Output**:
...
**Invocation**: `python apple-ii/scripts/boot_emulate_full.py [--woz PATH] [--output-dir DIR]`
**Output**:
...
**Invocation**: `python apple-ii/scripts/build_runtime.py [--input PATH] [--output PATH]`
...
**Invocation**: `python apple-ii/scripts/disassemble.py [--input PATH] [--output PATH]`
...
**Invocation**: `python apple-ii/scripts/verify_checksum.py`
...
**Invocation**: `python apple-ii/scripts/compare_decoders.py`
...
**Invocation**: `python apple-ii/scripts/check_wrap.py`
...
**Invocation**: `python apple-ii/scripts/scan_sector1.py`
...
**Invocation**: `python apple-ii/scripts/woz_62verify.py`
...
**Invocation**: `python apple-ii/scripts/woz_62compare.py`
